 ...
 */
public class S_eCO extends GCFServerBinder implements C_eCO {

	public static final String CO_TAB = S_eCO.class.getName()	+ "#CO_TAB";
	...
	public void defineBinder() {
		...
		// Table connectors
		addServerRule(new TC_eCO(this, getConnectionManager(0)));
