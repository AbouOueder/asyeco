...
public class S_Sub extends GCFServerBinder implements C_Sub  {

	/**
	 * Name of the resource table identifier for Tariff section table
	 */
	public static final String SER_CO_SUBMIT_TAB = S_eCO.class.getName() + "#SER_CO_SUBMIT_TAB";
	...
	public void defineBinder() {
		...
		TC_Sub tc_Reg = new TC_Sub(this, getConnectionManager(0));
