...
public class SR_ChkKeys extends KSR_DocumentRead implements C_Sub {

	public SR_ChkKeys(ServerBinder binder) {
		super(binder, KSR_DocumentRead.ERROR | KSR_DocumentRead.DOCUMENT_FOUND | KSR_DocumentRead.NON_KEYS_DATA, "", "Serial_submit",
