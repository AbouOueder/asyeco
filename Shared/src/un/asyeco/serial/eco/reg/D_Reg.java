 ...
 */
public class D_Reg extends KDocument implements C_Reg {


	/**
	 * 
	 */
	private static final long serialVersionUID = 4611773247449018661L;
	...
	public void define_FinderModel() {
		...
		setFinderInfo(new D_Reg.FinderInfoImpl());
