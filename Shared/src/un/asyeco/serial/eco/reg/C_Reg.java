...
public interface C_Reg {
	...
	// Operation event
	public static final int OI_CREATE = Operation.INTERNAL_OPERATIONS_MAX + 2001;

	public static final int OI_AMEND = Operation.INTERNAL_OPERATIONS_MAX + 2002;

	public static final int OI_DELETE = Operation.INTERNAL_OPERATIONS_MAX + 3003;
	...
	public static final int CTY_TAB_LOAD = INTERNAL_EVENTS_MAX + 143;	// Event fired when table is loaded
