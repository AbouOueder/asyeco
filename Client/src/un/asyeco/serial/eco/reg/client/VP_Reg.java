...
public class VP_Reg extends AWVisualTemplate implements C_Reg {
	...
	public void initVisualControls() {
		...
		addTitleStripeAndFlag(0, 0, 450, 25, lng("Certificate of Origin registration - serial data"));
