...
import un.asyeco.serial.eco.submit.client.rules.R_ChkKeys;
import un.asyeco.serial.eco.submit.client.rules.R_ChkLanguage;
import un.asyeco.serial.eco.submit.client.rules.R_RegDeleteConfirmation;
import un.asyeco.serial.eco.submit.client.rules.R_SetLocale;
import un.kernel.core.rules.KR_HTConnectorFactory;


public class DC_Sub extends ClientDocument implements C_Sub {

	void initRules(D_Sub doc) {
	...
	void initRules(D_Sub doc, VD_Sub vd) {
