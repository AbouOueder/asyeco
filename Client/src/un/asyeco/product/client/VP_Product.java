...
public class VP_Product extends AWVisualTemplate implements C_Product {
	...
	//CO country code
	transient private ElfField Cty_Cod = elfFieldPool.getElfField();
	
	// CO country name
	transient private ElfField Cty_Dsc = elfFieldPool.getElfField();
	...
	transient private ElfField Cmp_Prod_Cty = elfFieldPool.getElfField();
